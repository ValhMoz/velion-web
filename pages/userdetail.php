            ...
            <ul class="nav nav-pills mb-3" id="pills-tab" role="tablist">
                <li class="nav-item" role="presentation">
                    <button class="nav-link active" id="pills-about-tab" data-bs-toggle="pill"
                        ...
                        aria-selected="true" style="color: #000000">Acerca de</button>
                </li>
                <li class="nav-item" role="presentation">
                    <button class="nav-link" id="pills-appointments-tab" data-bs-toggle="pill"
                        ...
                        aria-selected="false" style="color: #000000">Citas</button>
                </li>
                <li class="nav-item" role="presentation">
                    <button class="nav-link" id="pills-history-tab" data-bs-toggle="pill"
                        ...
                        aria-selected="false" style="color: #000000">Historial Médico</button>
                </li>
                <?php
                if ($rol == "Paciente") {
                    echo '
                    ...
                    <div class="content-section">
                        ...
                        <ul class="list-group" style="margin-right: 10%">
                            <?php foreach ($citas as $cita): ?>
                                <li class="list-group-item"><? echo $cita['fecha_hora'] . ' ' . $cita['descripcion']; ?>
                                </li>
                            <?php endforeach; ?>
                        </ul>
                    </div>
                        ...
                        <ul class="list-group" style="margin-right: 10%">
                            <?php foreach ($informes as $informe): ?>
                                <li class="list-group-item">
                                    <? echo $informe['fecha_hora'] . ' ' . $informe['especialidad']; ?>
                                </li>
                            <?php endforeach; ?>
                        </ul>
                    </div>
                        ...
                        <div class="card" style="margin-right: 10%">
                            <div class="card-body">
                                <form action="../scripts/user_manager.php" method="POST">
                                    ...
                                    <div class="mb-2">
                                        <label for="email" class="form-label" style="margin-left: 5px;">Correo
                                            Electrónico:</label>
                                        <input type="email" class="form-control" id="email" name="email"
                                            placeholder="Correo electrónico" value="<?php echo $correo ?>">
                                    </div>
                                    <div class="mb-2">
                                        <label for="pass" class="form-label" style="margin-left: 5px;">Nueva
                                            contraseña:</label>
                                    ...
                                    <div class="mb-2">
                                        <label for="confirmPassword" class="form-label"
                                            style="margin-left: 5px;">Confirmar nueva contraseña:</label>
                                        <input type="password" class="form-control" id="confirmPass" name="confirmPass"
                                            placeholder="Confirmar Contraseña" required>
                                        <div id="passwordError" class="text-danger"></div>
                                    </div>
                                    <button type="submit" class="btn btn-light"
                                        onclick="return validatePassword()">Guardar Cambios</button>
                                </form>
                            </div>
                        </div>
                    </div>
