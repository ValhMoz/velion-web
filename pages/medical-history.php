                    ...
                    <div id="collapse<?php echo $cita['cita_id']; ?>" class="accordion-collapse collapse" aria-labelledby="heading<?php echo $cita['cita_id']; ?>" data-bs-parent="#accordionCitas">
                        <div class="accordion-body">
                            ...
                            <div class="card mb-4">
                                ...
                                <div class="card-body">
                                    <h5 class="card-title">Fecha del informe: <?php echo $cita['historial_fecha']; ?></h5>
                                    <p class="card-text">Diagnóstico: <?php echo $cita['historial_diagnostico']; ?></p>
                                    <p class="card-text">Tratamiento: <?php echo $cita['historial_tratamiento']; ?></p>
                                    <p class="card-text">Notas Adicionales: <?php echo $cita['historial_notas']; ?></p>
                                </div>
                            </div>
