...
if (!$_GET) {
    header('location:schedule.php?pagina=1');
}


$articulos_x_pagina = 10;

$horarios = $scheduleController->obtenerHorarios();
...
$n_botones_paginacion = ceil(count($horarios) / ($articulos_x_pagina));
...
include_once './modals/schedule/add_modal.php';
...
<div class="table-responsive small">
    ...
    <form class="row g-3" method="post">
        <div class="col-auto">
            <input type="text" class="form-control" id="nombre" name="nombre" placeholder="Filtrar por Nombre...">
        </div>
        <div class="col-auto">
                ...
                <table class="table">
                    <thead>
                        <tr>
                            ...
                            <th scope="col" style="width: 29%;">Última Modificación</th>
                    ...
                    <tbody>
                        <?php foreach ($horariosPaginados as $horario) : ?>
                            <tr>
                                <td><?php echo $horario['horario_id']; ?></td>
                                ...
                                <td><?php echo $horario['ult_modificacion']; ?></td>
                                <td>
                                    <button class="btn btn-sm btn-warning" data-bs-toggle="modal" data-bs-target="#edit_<?php echo $horario['horario_id']; ?>">
                                        <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-pencil-square" viewBox="0 0 16 16">
                                            <path d="M15.502 1.94a.5.5 0 0 1 0 .706L14.459 3.69l-2-2L13.502.646a.5.5 0 0 1 .707 0l1.293 1.293zm-1.75 2.456-2-2L4.939 9.21a.5.5 0 0 0-.121.196l-.805 2.414a.25.25 0 0 0 .316.316l2.414-.805a.5.5 0 0 0 .196-.12l6.813-6.814z" />
                                            <path fill-rule="evenodd" d="M1 13.5A1.5 1.5 0 0 0 2.5 15h11a1.5 1.5 0 0 0 1.5-1.5v-6a.5.5 0 0 0-1 0v6a.5.5 0 0 1-.5.5h-11a.5.5 0 0 1-.5-.5v-11a.5.5 0 0 1 .5-.5H9a.5.5 0 0 0 0-1H2.5A1.5 1.5 0 0 0 1 2.5z" />
                                        </svg>
                                    </button>
                                    <button class="btn btn-sm btn-danger" data-bs-toggle="modal" data-bs-target="#delete_<?php echo $horario['horario_id']; ?>">
                                        <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-trash" viewBox="0 0 16 16">
                                            <path d="M5.5 5.5A.5.5 0 0 1 6 6v6a.5.5 0 0 1-1 0V6a.5.5 0 0 1 .5-.5m2.5 0a.5.5 0 0 1 .5.5v6a.5.5 0 0 1-1 0V6a.5.5 0 0 1 .5-.5m3 .5a.5.5 0 0 0-1 0v6a.5.5 0 0 0 1 0z" />
                                            <path d="M14.5 3a1 1 0 0 1-1 1H13v9a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2V4h-.5a1 1 0 0 1-1-1V2a1 1 0 0 1 1-1H6a1 1 0 0 1 1-1h2a1 1 0 0 1 1 1h3.5a1 1 0 0 1 1 1zM4.118 4 4 4.059V13a1 1 0 0 0 1 1h6a1 1 0 0 0 1-1V4.059L11.882 4zM2.5 3h11V2h-11z" />
                                        </svg></button>
                                    <?php include './modals/schedule/edit_delete_modal.php'; ?>
    ...
    <nav aria-label="Page navigation example">
        <ul class="pagination justify-content-start">
            <li class="page-item <? echo $_GET['pagina'] <= 1 ? 'disabled' : '' ?>">
                <a class="page-link" href="schedule.php?pagina=<?php echo $_GET['pagina'] - 1 ?>">Anterior</a>
            </li>
            <?php for ($i = 0; $i < $n_botones_paginacion; $i++) : ?>
                <li class="page-item <? echo $_GET['pagina'] == $i + 1 ? 'active' : '' ?>"><a class="page-link" href="schedule.php?pagina=<?php echo $i + 1 ?>"><?php echo $i + 1 ?></a></li>
            <?php endfor ?>
            <li class="page-item <? echo $_GET['pagina'] >= $n_botones_paginacion ? 'disabled' : '' ?>">
                <a class="page-link" href="schedule.php?pagina=<?php echo $_GET['pagina'] + 1 ?>">Siguiente</a>
            </li>
        </ul>
    </nav>
